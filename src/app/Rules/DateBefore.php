...
class DateBefore extends AbstractDateComparison implements Rule
{
    /**
    ...
    public function passes($attribute, $value)
    {
        return $this->validateDates($value, function($dateBeingValidated, $dateToCheck) {
            $dateBeingValidated->greaterThanOrEqualTo($dateToCheck);
        });
    }
    ...
    public function message()
    {
        ...
        return "The :attribute date :input is not before these dates: {$dateString}";
    }
}
